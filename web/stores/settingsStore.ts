...
export const useSettingsStore = create<SettingsState>()((set, get) => ({
  ...
  visibleTabs: ['opencode', 'claudecode', 'codex', 'grok', 'geminicli', 'openclaw', 'pi', 'oh_my_pi', 'gateway', 'image', 'ssh', 'wsl'],
  ...
  initSettings: async () => {
    ...
    try {
      ...
      set({
        ...
        visibleTabs: settings.visible_tabs ?? ['opencode', 'claudecode', 'codex', 'grok', 'geminicli', 'openclaw', 'pi', 'oh_my_pi', 'gateway', 'image', 'ssh', 'wsl'],
