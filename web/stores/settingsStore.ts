...
export const useSettingsStore = create<SettingsState>()((set, get) => ({
  ...
  visibleTabs: ['opencode', 'claudecode', 'codex', 'geminicli', 'openclaw', 'pi', 'gateway', 'image', 'ssh', 'wsl'],
  ...
  initSettings: async () => {
    ...
    try {
      ...
      set({
        ...
        visibleTabs: settings.visible_tabs ?? ['opencode', 'claudecode', 'codex', 'geminicli', 'openclaw', 'pi', 'gateway', 'image', 'ssh', 'wsl'],
